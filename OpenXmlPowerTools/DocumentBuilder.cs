...
namespace OpenXmlPowerTools
{
    ...
    public static class DocumentBuilder
    {
        ...
        {
            using (WordprocessingDocument output = WordprocessingDocument.Create(fileName,
                DocumentFormat.OpenXml.WordprocessingDocumentType.Document))
            {
                BuildDocument(sources, output);
                output.FlushTrackedXDocuments();
            }
        }
        ...
        public static WmlDocument BuildDocument(List<Source> sources)
        {
            ...
            {
                using (WordprocessingDocument output = WordprocessingDocument.Create(ms,
                    DocumentFormat.OpenXml.WordprocessingDocumentType.Document))
                {
                    BuildDocument(sources, output);
                    output.FlushTrackedXDocuments();
            ...
            return new WmlDocument(byteArray);
        }
        ...
        private static void TestForUnsupportedDocument(WordprocessingDocument doc, int sourceNumber)
        {
            ...
            if (doc.MainDocumentPart.DocumentSettingsPart != null &&
                doc.MainDocumentPart.DocumentSettingsPart.GetXDocumentWithTracking().Descendants().Any(d => d.Name == W.src ||
            ...
            if (doc.MainDocumentPart.WebSettingsPart != null &&
                doc.MainDocumentPart.WebSettingsPart.GetXDocumentWithTracking().Descendants().Any(d => d.Name == W.frameset))
                throw new DocumentBuilderException(String.Format("Source {0} is unsupported document - contains a frameset", sourceNumber));
            if (doc.MainDocumentPart.GetXDocumentWithTracking().Descendants(W.numPr).Any() &&
        ...
        {
            XDocument mainDocumentXDoc = newDocument.MainDocumentPart.GetXDocumentWithTracking();
            ...
            XElement sectionMarkup, List<ImageData> images)
        {
            ...
            foreach (var headerReference in headerReferences)
            {
                ...
                XDocument oldHeaderXDoc = oldHeaderPart.GetXDocumentWithTracking();
                HeaderPart newHeaderPart = newDocument.MainDocumentPart.AddNewPart<HeaderPart>();
                XDocument newHeaderXDoc = newHeaderPart.GetXDocumentWithTracking();
            ...
            foreach (var footerReference in footerReferences)
            {
                ...
                XDocument oldFooterXDoc = oldFooterPart.GetXDocumentWithTracking();
                FooterPart newFooterPart = newDocument.MainDocumentPart.AddNewPart<FooterPart>();
                XDocument newFooterXDoc = newFooterPart.GetXDocumentWithTracking();
                    ...
                    foreach (XElement numReference in style.Descendants(W.numPr))
                    {
                        ...
                        if (idElement != null)
                        {
                            if (oldNumbering == null)
                                oldNumbering = sourceDocument.MainDocumentPart.NumberingDefinitionsPart.GetXDocumentWithTracking();
                            if (newNumbering == null)
                            {
                                if (newDocument.MainDocumentPart.NumberingDefinitionsPart != null)
                                {
                                    newNumbering = newDocument.MainDocumentPart.NumberingDefinitionsPart.GetXDocumentWithTracking();
            ...
            IEnumerable<XElement> newContent)
        {
            ...
            {
                XDocument oldStyles = sourceDocument.MainDocumentPart.StyleDefinitionsPart.GetXDocumentWithTracking();
                if (newDocument.MainDocumentPart.StyleDefinitionsPart == null)
                {
                    newDocument.MainDocumentPart.AddNewPart<StyleDefinitionsPart>();
                    XDocument newStyles = newDocument.MainDocumentPart.StyleDefinitionsPart.GetXDocumentWithTracking();
            ...
            {
                XDocument oldStyles = sourceDocument.MainDocumentPart.StylesWithEffectsPart.GetXDocumentWithTracking();
                if (newDocument.MainDocumentPart.StylesWithEffectsPart == null)
                {
                    newDocument.MainDocumentPart.AddNewPart<StylesWithEffectsPart>();
                    XDocument newStyles = newDocument.MainDocumentPart.StylesWithEffectsPart.GetXDocumentWithTracking();
                    newStyles.Declaration.Standalone = "yes";
                    newStyles.Declaration.Encoding = "UTF-8";
                    newStyles.Add(oldStyles.Root);
                }
            ...
            {
                XDocument oldFontTable = sourceDocument.MainDocumentPart.FontTablePart.GetXDocumentWithTracking();
                if (newDocument.MainDocumentPart.FontTablePart == null)
                {
                    newDocument.MainDocumentPart.AddNewPart<FontTablePart>();
                    XDocument newFontTable = newDocument.MainDocumentPart.FontTablePart.GetXDocumentWithTracking();
            ...
            IEnumerable<XElement> newContent, List<ImageData> images)
        {
            ...
            {
                if (oldComments == null)
                    oldComments = sourceDocument.MainDocumentPart.WordprocessingCommentsPart.GetXDocumentWithTracking();
                if (newComments == null)
                {
                    if (newDocument.MainDocumentPart.WordprocessingCommentsPart != null)
                    {
                        newComments = newDocument.MainDocumentPart.WordprocessingCommentsPart.GetXDocumentWithTracking();
                ...
                newDocument.MainDocumentPart.WordprocessingCommentsPart != null)
            {
                AddRelationships(sourceDocument.MainDocumentPart.WordprocessingCommentsPart,
                    ...
                    new[] { newDocument.MainDocumentPart.WordprocessingCommentsPart.GetXDocumentWithTracking().Root });
            ...
            WordprocessingDocument newDocument, IEnumerable<XElement> newContent)
        {
            ...
            int maxId = 0;
            if (newDocument.MainDocumentPart.GetXDocumentWithTracking().Descendants(W.bookmarkStart).Any())
                maxId = newDocument.MainDocumentPart.GetXDocumentWithTracking().Descendants(W.bookmarkStart)
            ...
            //    item.Attribute(DrawingmlNoNamespace.id).Value = s;
            //}
        }
        ...
        {
            int docPrId = 0;
            foreach (var item in newDocument.MainDocumentPart.GetXDocumentWithTracking().Descendants(WP.docPr))
                item.Attribute(DrawingmlNoNamespace.id).Value = (++docPrId).ToString();
            foreach (var header in newDocument.MainDocumentPart.HeaderParts)
                foreach (var item in header.GetXDocumentWithTracking().Descendants(WP.docPr))
                    item.Attribute(DrawingmlNoNamespace.id).Value = (++docPrId).ToString();
            foreach (var footer in newDocument.MainDocumentPart.FooterParts)
                foreach (var item in footer.GetXDocumentWithTracking().Descendants(WP.docPr))
                    item.Attribute(DrawingmlNoNamespace.id).Value = (++docPrId).ToString();
            if (newDocument.MainDocumentPart.FootnotesPart != null)
                foreach (var item in newDocument.MainDocumentPart.FootnotesPart.GetXDocumentWithTracking().Descendants(WP.docPr))
                    item.Attribute(DrawingmlNoNamespace.id).Value = (++docPrId).ToString();
            if (newDocument.MainDocumentPart.EndnotesPart != null)
                foreach (var item in newDocument.MainDocumentPart.EndnotesPart.GetXDocumentWithTracking().Descendants(WP.docPr))
                    item.Attribute(DrawingmlNoNamespace.id).Value = (++docPrId).ToString();
        }
            ...
            IEnumerable<XElement> newContent)
        {
            ...
            foreach (CustomXmlPart customXmlPart in sourceDocument.MainDocumentPart.CustomXmlParts)
            {
                OpenXmlPart propertyPart = customXmlPart
                    ...
                    .First();
                XDocument propertyPartDoc = propertyPart.GetXDocumentWithTracking();
                if (itemList.Contains(propertyPartDoc.Root.Attribute(DS.itemID).Value))
                {
                    ...
                    newPart.GetXDocumentWithTracking().Add(customXmlPart.GetXDocumentWithTracking().Root);
                    foreach (OpenXmlPart propPart in customXmlPart.Parts.Select(p => p.OpenXmlPart))
                    {
                        ...
                        newPropPart.GetXDocumentWithTracking().Add(propPart.GetXDocumentWithTracking().Root);
                    }
                }
            }
        }
            ...
            IEnumerable<XElement> newContent, List<ImageData> images)
        {
                ...
                sourceDocument.MainDocumentPart.NumberingDefinitionsPart != null)
            {
                AddRelationships(sourceDocument.MainDocumentPart.NumberingDefinitionsPart,
                    ...
                    new[] { newDocument.MainDocumentPart.NumberingDefinitionsPart.GetXDocumentWithTracking().Root });
                CopyRelatedPartsForContentParts(sourceDocument.MainDocumentPart.NumberingDefinitionsPart,
                    newDocument.MainDocumentPart.NumberingDefinitionsPart,
                    new[] { newDocument.MainDocumentPart.NumberingDefinitionsPart.GetXDocumentWithTracking().Root }, images);
            }
        }
            ...
            IEnumerable<XElement> newContent, List<ImageData> images)
        {
            ...
            foreach (XElement diagramReference in newContent.DescendantsAndSelf().Where(d => d.Name == DGM.relIds || d.Name == A.relIds))
            {
                ...
                newPart.GetXDocumentWithTracking().Add(oldPart.GetXDocumentWithTracking().Root);
                diagramReference.Attribute(R.dm).Value = newContentPart.GetIdOfPart(newPart);
                AddRelationships(oldPart, newPart, new[] { newPart.GetXDocumentWithTracking().Root });
                CopyRelatedPartsForContentParts(oldPart, newPart, new[] { newPart.GetXDocumentWithTracking().Root }, images);
            ...
            foreach (XElement chartReference in newContent.DescendantsAndSelf(C.chart))
            {
                try
                {
                    ...
                    XDocument oldChart = oldPart.GetXDocumentWithTracking();
                    ChartPart newPart = newContentPart.AddNewPart<ChartPart>();
                    XDocument newChart = newPart.GetXDocumentWithTracking();
            ...
            foreach (XElement userShape in newContent.DescendantsAndSelf(C.userShapes))
            {
                try
                {
                    ...
                    XDocument oldXDoc = oldPart.GetXDocumentWithTracking();
                    ChartDrawingPart newPart = newContentPart.AddNewPart<ChartDrawingPart>();
                    XDocument newXDoc = newPart.GetXDocumentWithTracking();
        ...
        {
            var relevantElements = oldFontTablePart.GetXDocumentWithTracking().Descendants().Where(d => d.Name == W.embedRegular ||
        ...
        {
            foreach (XElement dataReference in newChart.GetXDocumentWithTracking().Descendants(C.externalData))
            {
            ...
            List<ImageData> images)
        {
            ...
            if (corePart != null && corePart.GetXDocumentWithTracking().Root != null)
            {
                newDocument.AddCoreFilePropertiesPart();
                XDocument newXDoc = newDocument.CoreFilePropertiesPart.GetXDocumentWithTracking();
                newXDoc.Declaration.Standalone = "yes";
                newXDoc.Declaration.Encoding = "UTF-8";
                XDocument sourceXDoc = corePart.GetXDocumentWithTracking();
            ...
            if (extPart != null)
            {
                ...
                XDocument newXDoc = newDocument.ExtendedFilePropertiesPart.GetXDocumentWithTracking();
                newXDoc.Declaration.Standalone = "yes";
                newXDoc.Declaration.Encoding = "UTF-8";
                newXDoc.Add(extPart.GetXDocumentWithTracking().Root);
            }
            ...
            if (customPart != null)
            {
                ...
                XDocument newXDoc = newDocument.CustomFilePropertiesPart.GetXDocumentWithTracking();
                newXDoc.Declaration.Standalone = "yes";
                newXDoc.Declaration.Encoding = "UTF-8";
                newXDoc.Add(customPart.GetXDocumentWithTracking().Root);
            }
            ...
            if (oldSettingsPart != null)
            {
                ...
                XDocument settingsXDoc = oldSettingsPart.GetXDocumentWithTracking();
                ...
                XDocument newXDoc = newDocument.MainDocumentPart.DocumentSettingsPart.GetXDocumentWithTracking();
                newXDoc.Declaration.Standalone = "yes";
                newXDoc.Declaration.Encoding = "UTF-8";
            ...
            if (oldWebSettingsPart != null)
            {
                ...
                XDocument settingsXDoc = oldWebSettingsPart.GetXDocumentWithTracking();
                AddRelationships(oldWebSettingsPart, newWebSettingsPart, new[] { settingsXDoc.Root });
                XDocument newXDoc = newDocument.MainDocumentPart.WebSettingsPart.GetXDocumentWithTracking();
                newXDoc.Declaration.Standalone = "yes";
                newXDoc.Declaration.Encoding = "UTF-8";
                newXDoc.Add(settingsXDoc.Root);
            }
            ...
            if (themePart != null)
            {
                ...
                XDocument newXDoc = newDocument.MainDocumentPart.ThemePart.GetXDocumentWithTracking();
                newXDoc.Declaration.Standalone = "yes";
                newXDoc.Declaration.Encoding = "UTF-8";
                newXDoc.Add(themePart.GetXDocumentWithTracking().Root);
                CopyRelatedPartsForContentParts(themePart, newThemePart, new[] { newThemePart.GetXDocumentWithTracking().Root }, images);
            }
            ...
            {
                newDocument.MainDocumentPart.AddNewPart<StyleDefinitionsPart>();
                XDocument newXDoc = newDocument.MainDocumentPart.StyleDefinitionsPart.GetXDocumentWithTracking();
                newXDoc.Declaration.Standalone = "yes";
                newXDoc.Declaration.Encoding = "UTF-8";
                newXDoc.Add(stylesPart.GetXDocumentWithTracking().Root);
            }
            ...
            {
                newDocument.MainDocumentPart.AddNewPart<StylesWithEffectsPart>();
                XDocument newXDoc = newDocument.MainDocumentPart.StylesWithEffectsPart.GetXDocumentWithTracking();
                newXDoc.Declaration.Standalone = "yes";
                newXDoc.Declaration.Encoding = "UTF-8";
                newXDoc.Add(stylesWithEffectsPart.GetXDocumentWithTracking().Root);
            }
            ...
            {
                newDocument.MainDocumentPart.AddNewPart<NumberingDefinitionsPart>();
                XDocument newXDoc = newDocument.MainDocumentPart.NumberingDefinitionsPart.GetXDocumentWithTracking();
                newXDoc.Declaration.Standalone = "yes";
                newXDoc.Declaration.Encoding = "UTF-8";
                newXDoc.Add(numberingPart.GetXDocumentWithTracking().Root);
            ...
            {
                newDocument.MainDocumentPart.AddNewPart<FontTablePart>();
                XDocument newXDoc = newDocument.MainDocumentPart.FontTablePart.GetXDocumentWithTracking();
                newXDoc.Declaration.Standalone = "yes";
                newXDoc.Declaration.Encoding = "UTF-8";
                CopyFontTable(sourceDocument.MainDocumentPart.FontTablePart, newDocument.MainDocumentPart.FontTablePart);
                newXDoc.Add(fontTablePart.GetXDocumentWithTracking().Root);
            }
        }
            ...
            XDocument settingsXDoc, List<ImageData> images)
        {
            ...
            foreach (XElement footnote in footnotePr.Elements(W.footnote))
            {
                if (oldFootnotes == null)
                    oldFootnotes = sourceDocument.MainDocumentPart.FootnotesPart.GetXDocumentWithTracking();
                if (newFootnotes == null)
                {
                    if (newDocument.MainDocumentPart.FootnotesPart != null)
                    {
                        newFootnotes = newDocument.MainDocumentPart.FootnotesPart.GetXDocumentWithTracking();
            ...
            XDocument settingsXDoc, List<ImageData> images)
        {
            ...
            {
                if (oldEndnotes == null)
                    oldEndnotes = sourceDocument.MainDocumentPart.EndnotesPart.GetXDocumentWithTracking();
                if (newEndnotes == null)
                {
                    if (newDocument.MainDocumentPart.EndnotesPart != null)
                    {
                        newEndnotes = newDocument.MainDocumentPart.EndnotesPart.GetXDocumentWithTracking();
        ...
        private static void FixRanges(XDocument sourceDocument, IEnumerable<XElement> newContent)
        {
            ...
            IEnumerable<XElement> newContent, List<ImageData> images)
        {
                ...
                newDocument.MainDocumentPart.FootnotesPart != null)
            {
                AddRelationships(sourceDocument.MainDocumentPart.FootnotesPart,
                    ...
                    new[] { newDocument.MainDocumentPart.FootnotesPart.GetXDocumentWithTracking().Root });
                CopyRelatedPartsForContentParts(sourceDocument.MainDocumentPart.FootnotesPart,
                    newDocument.MainDocumentPart.FootnotesPart,
                    new[] { newDocument.MainDocumentPart.FootnotesPart.GetXDocumentWithTracking().Root }, images);
            }
        }
            ...
            IEnumerable<XElement> newContent, List<ImageData> images)
        {
                ...
                newDocument.MainDocumentPart.EndnotesPart != null)
            {
                AddRelationships(sourceDocument.MainDocumentPart.EndnotesPart,
                    ...
                    new[] { newDocument.MainDocumentPart.EndnotesPart.GetXDocumentWithTracking().Root });
                CopyRelatedPartsForContentParts(sourceDocument.MainDocumentPart.EndnotesPart,
                    newDocument.MainDocumentPart.EndnotesPart,
                    new[] { newDocument.MainDocumentPart.EndnotesPart.GetXDocumentWithTracking().Root }, images);
            }
        }
